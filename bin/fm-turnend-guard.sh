...
block_stop() {
  ...
  rule='━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    if [ "$FM_SUP_REASON_COUNT" -gt 0 ]; then
      printf '●  %s %s, but no live watcher holds this home lock (last beat: %s).\n' "$FM_SUP_REASON_COUNT" "$FM_SUP_REASON_LABEL" "$FM_SUP_BEACON_DESC"
    else
...
if [ "$terminal_status" -eq 0 ]; then
  if [ "$FM_SUP_REASON_COUNT" -gt 0 ]; then
    NEED_DESC="$FM_SUP_REASON_COUNT $FM_SUP_REASON_LABEL"
  else
